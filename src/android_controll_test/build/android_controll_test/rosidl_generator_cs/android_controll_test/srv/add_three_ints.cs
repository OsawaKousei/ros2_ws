...
public class AddThreeInts_Request : MessageInternals, Message
{
  ...
  static private void MessageTypeSupportPreload()
  {
    ...
    { //only affects Linux since on Windows PATH can be set effectively, dynamically
        ...
        { // TODO - get rcl level constants, e.g. rosidl_typesupport_fastrtps_c__identifier
          ...
          IntPtr messageLibraryTypesupportFastRTPS_CPP = loadUtils.LoadLibraryNoSuffix("android_controll_test__rosidl_typesupport_fastrtps_cpp");
          IntPtr messageLibraryTypesupportFastRTPS_C = loadUtils.LoadLibraryNoSuffix("android_controll_test__rosidl_typesupport_fastrtps_c");
      }
    }
  }
  ...
  static AddThreeInts_Request()
  {
    ...
    IntPtr messageLibraryTypesupport = dllLoadUtils.LoadLibraryNoSuffix("android_controll_test__rosidl_typesupport_c");
    IntPtr messageLibraryGenerator = dllLoadUtils.LoadLibraryNoSuffix("android_controll_test__rosidl_generator_c");
    IntPtr messageLibraryIntro = dllLoadUtils.LoadLibraryNoSuffix("android_controll_test__rosidl_typesupport_introspection_c");
    MessageTypeSupportPreload();

    IntPtr nativelibrary = dllLoadUtils.LoadLibrary("android_controll_test_srv_add_three_ints__rosidl_typesupport_c");
    IntPtr native_get_typesupport_ptr = dllLoadUtils.GetProcAddress(nativelibrary, "android_controll_test__srv__AddThreeInts_Request_native_get_type_support");
    ...
    IntPtr native_create_native_message_ptr = dllLoadUtils.GetProcAddress(nativelibrary, "android_controll_test__srv__AddThreeInts_Request_native_create_native_message");
    ...
    IntPtr native_destroy_native_message_ptr = dllLoadUtils.GetProcAddress(nativelibrary, "android_controll_test__srv__AddThreeInts_Request_native_destroy_native_message");
    ...
    IntPtr native_read_field_a_ptr =
      dllLoadUtils.GetProcAddress(nativelibrary, "android_controll_test__srv__AddThreeInts_Request_native_read_field_a");
    ...
    IntPtr native_write_field_a_ptr =
      dllLoadUtils.GetProcAddress(nativelibrary, "android_controll_test__srv__AddThreeInts_Request_native_write_field_a");
    ...
    IntPtr native_read_field_b_ptr =
      dllLoadUtils.GetProcAddress(nativelibrary, "android_controll_test__srv__AddThreeInts_Request_native_read_field_b");
    ...
    IntPtr native_write_field_b_ptr =
      dllLoadUtils.GetProcAddress(nativelibrary, "android_controll_test__srv__AddThreeInts_Request_native_write_field_b");
    ...
    IntPtr native_read_field_c_ptr =
      dllLoadUtils.GetProcAddress(nativelibrary, "android_controll_test__srv__AddThreeInts_Request_native_read_field_c");
    ...
    IntPtr native_write_field_c_ptr =
      dllLoadUtils.GetProcAddress(nativelibrary, "android_controll_test__srv__AddThreeInts_Request_native_write_field_c");
...
public class AddThreeInts_Response : MessageInternals, Message
{
  ...
  static AddThreeInts_Response()
  {
    ...
    IntPtr nativelibrary = dllLoadUtils.LoadLibrary("android_controll_test_srv_add_three_ints__rosidl_typesupport_c");
    IntPtr native_get_typesupport_ptr = dllLoadUtils.GetProcAddress(nativelibrary, "android_controll_test__srv__AddThreeInts_Response_native_get_type_support");
    AddThreeInts_Response.native_get_typesupport = (NativeGetTypeSupportType)Marshal.GetDelegateForFunctionPointer(
      native_get_typesupport_ptr, typeof(NativeGetTypeSupportType));

    IntPtr native_create_native_message_ptr = dllLoadUtils.GetProcAddress(nativelibrary, "android_controll_test__srv__AddThreeInts_Response_native_create_native_message");
    AddThreeInts_Response.native_create_native_message = (NativeCreateNativeMessageType)Marshal.GetDelegateForFunctionPointer(
      native_create_native_message_ptr, typeof(NativeCreateNativeMessageType));

    IntPtr native_destroy_native_message_ptr = dllLoadUtils.GetProcAddress(nativelibrary, "android_controll_test__srv__AddThreeInts_Response_native_destroy_native_message");
    ...
    IntPtr native_read_field_sum_ptr =
      dllLoadUtils.GetProcAddress(nativelibrary, "android_controll_test__srv__AddThreeInts_Response_native_read_field_sum");
    ...
    IntPtr native_write_field_sum_ptr =
      dllLoadUtils.GetProcAddress(nativelibrary, "android_controll_test__srv__AddThreeInts_Response_native_write_field_sum");
