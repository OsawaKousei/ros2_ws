...
#ifndef ANDROID_CONTROLL_TEST__MSG__DETAIL__CUSTOM_UNITY__FUNCTIONS_H_
#define ANDROID_CONTROLL_TEST__MSG__DETAIL__CUSTOM_UNITY__FUNCTIONS_H_
 ...
 * calls
 * android_controll_test__msg__CustomUnity__init().
...
/**
 * It calls
 * android_controll_test__msg__CustomUnity__fini()
 ...
 * android_controll_test__msg__CustomUnity__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * android_controll_test__msg__CustomUnity__Sequence__fini()
 * on the array,
...
#endif  // ANDROID_CONTROLL_TEST__MSG__DETAIL__CUSTOM_UNITY__FUNCTIONS_H_
