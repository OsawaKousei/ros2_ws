...
#include "android_controll_test/srv/detail/add_three_ints__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const android_controll_test::srv::AddThreeInts_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  android_controll_test::srv::AddThreeInts_Request & ros_message)
{
  // Member: a
  cdr >> ros_message.a;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = android_controll_test::srv::AddThreeInts_Request;
    is_plain =
      (
      offsetof(DataType, c) +
      last_member_size
...
{
  auto typed_message =
    static_cast<const android_controll_test::srv::AddThreeInts_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<android_controll_test::srv::AddThreeInts_Request *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_android_controll_test
const rosidl_message_type_support_t *
get_message_type_support_handle<android_controll_test::srv::AddThreeInts_Request>()
{
  return &android_controll_test::srv::typesupport_fastrtps_cpp::_AddThreeInts_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, android_controll_test, srv, AddThreeInts_Request)() {
  return &android_controll_test::srv::typesupport_fastrtps_cpp::_AddThreeInts_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_android_controll_test
cdr_serialize(
  const android_controll_test::srv::AddThreeInts_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: sum
  cdr << ros_message.sum;
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  android_controll_test::srv::AddThreeInts_Response & ros_message)
{
  // Member: sum
  cdr >> ros_message.sum;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = android_controll_test::srv::AddThreeInts_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const android_controll_test::srv::AddThreeInts_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<android_controll_test::srv::AddThreeInts_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &android_controll_test::srv::typesupport_fastrtps_cpp::_AddThreeInts_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, android_controll_test, srv, AddThreeInts_Response)() {
  return &android_controll_test::srv::typesupport_fastrtps_cpp::_AddThreeInts_Response__handle;
}
...
{
  return &android_controll_test::srv::typesupport_fastrtps_cpp::_AddThreeInts__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, android_controll_test, srv, AddThreeInts)() {
  return &android_controll_test::srv::typesupport_fastrtps_cpp::_AddThreeInts__handle;
}
