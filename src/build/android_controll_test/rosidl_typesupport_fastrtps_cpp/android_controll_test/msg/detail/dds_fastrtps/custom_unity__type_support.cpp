...
#include "android_controll_test/msg/detail/custom_unity__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = android_controll_test::msg::CustomUnity;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const android_controll_test::msg::CustomUnity *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<android_controll_test::msg::CustomUnity *>(
    untyped_ros_message);
...
{
  return &android_controll_test::msg::typesupport_fastrtps_cpp::_CustomUnity__handle;
}
