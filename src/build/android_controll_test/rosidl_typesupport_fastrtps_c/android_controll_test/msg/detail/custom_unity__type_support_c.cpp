...
#include "android_controll_test/msg/detail/custom_unity__rosidl_typesupport_fastrtps_c.h"
...
using _CustomUnity__ros_msg_type = android_controll_test__msg__CustomUnity;
...
size_t get_serialized_size_android_controll_test__msg__CustomUnity(
  const void * untyped_ros_message,
...
static uint32_t _CustomUnity__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_android_controll_test__msg__CustomUnity(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_android_controll_test
size_t max_serialized_size_android_controll_test__msg__CustomUnity(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = android_controll_test__msg__CustomUnity;
    is_plain =
      (
      offsetof(DataType, f3) +
      last_member_size
      ) == ret_val;
  }
...
static size_t _CustomUnity__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_android_controll_test__msg__CustomUnity(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, android_controll_test, msg, CustomUnity)() {
