...
bool android_controll_test__msg__custom_unity__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("android_controll_test.msg._custom_unity.CustomUnity", full_classname_dest, 51) == 0);
  }
  android_controll_test__msg__CustomUnity * ros_message = _ros_message;
  {  // f1
...
PyObject * android_controll_test__msg__custom_unity__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("android_controll_test.msg._custom_unity");
