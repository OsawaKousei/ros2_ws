...
static const _CustomUnity_type_support_symbol_names_t _CustomUnity_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, custom_message_unity, msg, CustomUnity)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, custom_message_unity, msg, CustomUnity)),
  }
};
...
{
  return &::custom_message_unity::msg::rosidl_typesupport_cpp::CustomUnity_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, custom_message_unity, msg, CustomUnity)() {
  return get_message_type_support_handle<custom_message_unity::msg::CustomUnity>();
}
