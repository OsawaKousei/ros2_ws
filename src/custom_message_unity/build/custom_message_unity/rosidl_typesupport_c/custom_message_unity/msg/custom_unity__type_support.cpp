...
static const _CustomUnity_type_support_symbol_names_t _CustomUnity_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, custom_message_unity, msg, CustomUnity)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, custom_message_unity, msg, CustomUnity)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, custom_message_unity, msg, CustomUnity)() {
  return &::custom_message_unity::msg::rosidl_typesupport_c::CustomUnity_message_type_support_handle;
}
