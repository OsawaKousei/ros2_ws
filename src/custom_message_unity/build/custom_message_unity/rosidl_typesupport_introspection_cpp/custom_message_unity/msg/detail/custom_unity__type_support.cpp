...
{
  new (message_memory) custom_message_unity::msg::CustomUnity(_init);
}

void CustomUnity_fini_function(void * message_memory)
{
  auto typed_message = static_cast<custom_message_unity::msg::CustomUnity *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember CustomUnity_message_member_array[3] = {
  {
    ...
    offsetof(custom_message_unity::msg::CustomUnity, f1),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(custom_message_unity::msg::CustomUnity, f2),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(custom_message_unity::msg::CustomUnity, f3),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers CustomUnity_message_members = {
  "custom_message_unity::msg",  // message namespace
  "CustomUnity",  // message name
  3,  // number of fields
  sizeof(custom_message_unity::msg::CustomUnity),
...
{
  return &::custom_message_unity::msg::rosidl_typesupport_introspection_cpp::CustomUnity_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, custom_message_unity, msg, CustomUnity)() {
  return &::custom_message_unity::msg::rosidl_typesupport_introspection_cpp::CustomUnity_message_type_support_handle;
}
