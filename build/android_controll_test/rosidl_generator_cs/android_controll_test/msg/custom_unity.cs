...
public class CustomUnity : MessageInternals, Message
{
  ...
  static CustomUnity()
  {
    ...
    IntPtr nativelibrary = dllLoadUtils.LoadLibrary("android_controll_test_custom_unity__rosidl_typesupport_c");
    IntPtr native_get_typesupport_ptr = dllLoadUtils.GetProcAddress(nativelibrary, "android_controll_test__msg__CustomUnity_native_get_type_support");
    ...
    IntPtr native_create_native_message_ptr = dllLoadUtils.GetProcAddress(nativelibrary, "android_controll_test__msg__CustomUnity_native_create_native_message");
    ...
    IntPtr native_destroy_native_message_ptr = dllLoadUtils.GetProcAddress(nativelibrary, "android_controll_test__msg__CustomUnity_native_destroy_native_message");
    ...
    IntPtr native_read_field_f1_ptr =
      dllLoadUtils.GetProcAddress(nativelibrary, "android_controll_test__msg__CustomUnity_native_read_field_f1");
    ...
    IntPtr native_write_field_f1_ptr =
      dllLoadUtils.GetProcAddress(nativelibrary, "android_controll_test__msg__CustomUnity_native_write_field_f1");
    ...
    IntPtr native_read_field_f2_ptr =
      dllLoadUtils.GetProcAddress(nativelibrary, "android_controll_test__msg__CustomUnity_native_read_field_f2");
    ...
    IntPtr native_write_field_f2_ptr =
      dllLoadUtils.GetProcAddress(nativelibrary, "android_controll_test__msg__CustomUnity_native_write_field_f2");
    ...
    IntPtr native_read_field_f3_ptr =
      dllLoadUtils.GetProcAddress(nativelibrary, "android_controll_test__msg__CustomUnity_native_read_field_f3");
    ...
    IntPtr native_write_field_f3_ptr =
      dllLoadUtils.GetProcAddress(nativelibrary, "android_controll_test__msg__CustomUnity_native_write_field_f3");
