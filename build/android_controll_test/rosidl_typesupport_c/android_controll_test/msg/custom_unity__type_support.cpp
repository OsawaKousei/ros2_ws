...
static const _CustomUnity_type_support_symbol_names_t _CustomUnity_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, android_controll_test, msg, CustomUnity)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, android_controll_test, msg, CustomUnity)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, android_controll_test, msg, CustomUnity)() {
  return &::android_controll_test::msg::rosidl_typesupport_c::CustomUnity_message_type_support_handle;
}
