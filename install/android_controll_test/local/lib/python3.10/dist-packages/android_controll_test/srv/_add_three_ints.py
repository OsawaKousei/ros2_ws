...
class Metaclass_AddThreeInts(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'android_controll_test.srv.AddThreeInts')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from android_controll_test.srv import _add_three_ints
...
class AddThreeInts(metaclass=Metaclass_AddThreeInts):
    from android_controll_test.srv._add_three_ints import AddThreeInts_Request as Request
    from android_controll_test.srv._add_three_ints import AddThreeInts_Response as Response
